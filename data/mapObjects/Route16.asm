Route16_Object:
	...
	db 7 ; objects
	object SPRITE_BIKER, 20, 14, STAY, DOWN, 1, OPP_BIKER, 5
	object SPRITE_BIKER, 16, 14, STAY, DOWN, 2, OPP_CUE_BALL, 1
	object SPRITE_BIKER, 13, 16, STAY, UP, 3, OPP_CUE_BALL, 2
	object SPRITE_BIKER,  5, 14, STAY, LEFT, 4, OPP_BIKER, 6
	object SPRITE_BIKER, 10, 14, STAY, DOWN, 5, OPP_CUE_BALL, 3
