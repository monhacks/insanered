MtMoonB1F_Object:
	...
	warp 25, 27, 4, MT_MOON_1F
	warp 25, 23, 1, MT_MOON_B2F
	...
	warp_to 25, 27, MT_MOON_B1F_WIDTH ; MT_MOON_1F
	warp_to 25, 23, MT_MOON_B1F_WIDTH ; MT_MOON_B2F
	warp_to 13, 27, MT_MOON_B1F_WIDTH ; MT_MOON_B2F
	warp_to 23, 3, MT_MOON_B1F_WIDTH ; MT_MOON_B2F
	warp_to 25,  4, MT_MOON_B1F_WIDTH
