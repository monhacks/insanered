Route10_Object:
	...
	db 6 ; objects
	object SPRITE_BLACK_HAIR_BOY_2, 15, 41, STAY, LEFT, 1, OPP_POKEMANIAC, 1
	object SPRITE_HIKER,  9, 57, STAY, LEFT, 2, OPP_HIKER, 7
	object SPRITE_BLACK_HAIR_BOY_2, 15, 65, STAY, DOWN, 3, OPP_POKEMANIAC, 2
	object SPRITE_LASS,  9, 27, STAY, LEFT, 4, OPP_JR_TRAINER_F, 7
	object SPRITE_HIKER, 13, 58, STAY, RIGHT, 5, OPP_HIKER, 8
	object SPRITE_LASS,  6, 61, STAY, RIGHT, 6, OPP_JR_TRAINER_F, 8
