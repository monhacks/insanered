CeruleanCity_Object:
	...
	object SPRITE_BLACK_HAIR_BOY_1, 29, 20, STAY, DOWN, 3 ; person
	object SPRITE_BLACK_HAIR_BOY_2, 15, 18, WALK, 1, 4 ; person
	object SPRITE_BLACK_HAIR_BOY_2, 26, 15, WALK, 2, 5 ; person
	...
	warp_to 28, 19, CERULEAN_CITY_WIDTH ; CERULEAN_GYM
