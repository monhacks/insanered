...
MoveEnd:
	...
	move FURY_CUTTER,  TWO_TO_FIVE_ATTACKS_EFFECT,  40, BUG,       80, 15
	move GIGA_DRAIN,   DRAIN_HP_EFFECT,             75, GRASS,    100, 10
	move OUTRAGE,      THRASH_PETAL_DANCE_EFFECT,  120, DRAGON,   100, 20
	move AEROBLAST,    NO_ADDITIONAL_EFFECT,       150, FLYING,    90,  5
	move SLUDGE_BOMB,  POISON_SIDE_EFFECT2,         90, POISON,   100, 20
	move EXTREMESPEED, NO_ADDITIONAL_EFFECT,        80, NORMAL,   100, 10
	move ICICLE_SPEAR, TWO_TO_FIVE_ATTACKS_EFFECT,  15, ICE,       85, 20
