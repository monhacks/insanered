...
; Route 11
	...
	db 26,VICTREEBEL,CHARMELEON,FARFETCHD,POLIWRATH,ELECTABUZZ,SANDSLASH,0
...
; Fuchsia Gym
	db 61,DROWZEE,DROWZEE,KADABRA,DROWZEE,0
	db 63,DROWZEE,HYPNO,0
; Victory Road 2F
	db 87,RAPIDASH,0
; Unused
	db 33,HYPNO,0
...
; Silph Co. 9F
	db 68,STARMIE,0
; Silph Co. 10F
	db 64,LICKITUNG,STARMIE,EXEGGUTOR,LAPRAS,KADABRA,0
; Mansion 3F
...
LtSurgeData:
	db $FF,34,ELECTRODE,34,MAGNETON,35,JOLTEON,35,ELECTABUZZ,36,RAICHU,36,ZAPDOS,0
ErikaData:
...
BlaineData:
	db $FF,81,CHARIZARD,81,FLAREON,81,NINETALES,81,CHANSEY,81,ARCANINE,81,MAGMAR,0
SabrinaData:
